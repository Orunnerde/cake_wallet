...
A new flutter plugin project.
  ...
  s.subspec 'Monero' do |monero|
    ...
    monero.vendored_libraries = 'External/ios/libs/monero/libs/lib-x86_64/*.a'
    monero.libraries = 'easylogging', 'epee', 'unbound', 'wallet_merged', 'lmdb'
  ...
  s.subspec 'Boost' do |boost|
    ...
    boost.vendored_libraries = 'External/ios/libs/boost/build/libs/x86_64/*.a' #, 'External/ios/libs/boost/build/libs/arm64/*.a', 'External/ios/libs/boost/build/libs/armv7/*.a'
